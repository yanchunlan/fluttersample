...
import 'package:test_lint_plugin/mirror_visitor.dart';
import 'package:test_lint_plugin/utils/map_utils.dart';
...
Future<List<AnalysisError>> collectAnalyzerErrors(
  ...
  for (final filePath in paths) {
    ...
    final issuesInFile = MirrorChecker((unit as ResolvedUnitResult).unit).enumToStringErrors();
    analysisErrors.addAll(issuesInFile
        .map((issue) => analysisErrorFor(filePath, issue, (unit as ResolvedUnitResult).unit)));
  }
